...
/**
 * @fileOverview Generates multiple-choice quiz questions based on a selected topic using AI.
 *
...
const generateQuizQuestionsPrompt = ai.definePrompt({
  ...
  prompt: `You are a quiz generator. Generate 5 multiple-choice questions based on the topic provided.
